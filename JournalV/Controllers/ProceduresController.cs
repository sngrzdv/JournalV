...
namespace JournalV.Controllers
{
    ...
    public class ProceduresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Cost")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Cost")] Procedure procedure)
        {
            if (id != procedure.Id)
            {
                return NotFound();
